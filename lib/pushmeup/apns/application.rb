  ...
  class Application
    ...
    protected
      ...
      def start_connection(host)
        raise Exceptions::PushmeupException.new(I18n.t('errors.internal.pem_is_not_set')) unless @pem_location
        raise Exceptions::PushmeupException.new(I18n.t('errors.internal.pem_does_not_exist')) unless File.exists?(@pem_location)
